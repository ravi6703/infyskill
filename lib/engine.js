...
export function selectModules(targetSkills, allModules, { knownClusters = [], knownSkills = [], maxHours = 100, fastTrack = false } = {}) {
...
export function buildWeekPlan(targetSkills, allModules, opts = {}) {
  ...
  const mods = selectModules(targetSkills, allModules, { knownClusters, knownSkills, maxHours: maxAsync, fastTrack });
